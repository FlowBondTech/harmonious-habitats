-- Safe Comprehensive Database Migration for Harmony Spaces
...
BEGIN
  ...
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'user_location_preferences') THEN
  ...
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'facilitator_availability') THEN
...
-- COMPLETION MESSAGE
-- ========================================
-- Safe migration completed! This version handles existing tables properly.
-- All missing columns have been added and new tables created as needed.