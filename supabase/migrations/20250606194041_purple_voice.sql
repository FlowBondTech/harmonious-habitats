/*
  ...
  3. Functions
    - Auto-generate unique invite codes with beautiful words
...
DROP POLICY IF EXISTS "Anyone can view unused invite codes for validation" ON invite_codes;
DROP POLICY IF EXISTS "System can update invite codes when used" ON invite_codes;
DROP POLICY IF EXISTS "Admins can delete any invite code" ON invite_codes;
...
DROP POLICY IF EXISTS "Space holders can update their own spaces" ON spaces;
DROP POLICY IF EXISTS "Space holders can delete their own spaces" ON spaces;
DROP POLICY IF EXISTS "Admins can update any space" ON spaces;
DROP POLICY IF EXISTS "Admins can delete any space" ON spaces;

DROP POLICY IF EXISTS "Users can view all attendees" ON space_attendees;
DROP POLICY IF EXISTS "Users can join spaces" ON space_attendees;
DROP POLICY IF EXISTS "Users can leave spaces" ON space_attendees;
DROP POLICY IF EXISTS "Admins can view all space attendees" ON space_attendees;
DROP POLICY IF EXISTS "Admins can remove users from spaces" ON space_attendees;
