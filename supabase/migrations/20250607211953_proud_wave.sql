/*
  # Fix admin setup and first user auto-promotion

  1. Setup
    - Insert default admin invite code if it doesn't exist
    - Drop and recreate function to avoid conflicts
    - Create trigger to auto-promote first user to admin

  2. Security
    - Ensures there's always a way for the first admin to get access
    - Automatically promotes first user to admin status
*/
