  ...
  return (
    <aside
      ...
      <div className="h-full flex flex-col">
        <div className="flex-1 overflow-y-auto overflow-x-hidden sidebar-scroll text-sm leading-tight">
          ...
          <nav className={`${!user || favoriteSpaces.length === 0 ? 'p-4 -mt-0.5 md:mt-0' : 'px-4 pb-4'} space-y-1`}>
            {navItems.map((item) => (
              <NavItem
                key={item.path}
                {...item}
        ...
        {/* Auth Section for Non-authenticated Users - Fixed at bottom */}
        {!user && (
          <div className="flex-shrink-0 border-t border-gray-100 p-4 bg-white">
